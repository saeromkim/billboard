...
?>
			 <div id="list_item">
				<ul>
				<li style="width:10%; height:200px" id="list_item1"><?= $item_rank ?></li>
				<li style="width:40%; height:200px" id="list_item2"><?= $item_mname ?></li>
				<li style="width:20%; height:200px"id="list_item3"><?= $item_artist ?></li>
